...
const models = [
  { id: "WM-DOC-INT-001", name: "WM Document Intelligence", version: "1.0.0", vendor: "WM AI Platform", methodology: "RAG + GPT-4o structured output + business rules validation", baseModel: "gpt-4o", risk: "high", status: "certified", usesRag: true, handlesPii: false, clientFacing: false, dataClass: "confidential", certDate: "2026-01-15", nextRecert: "2026-07-15", owner: "AI Platform Team" },
  { id: "WM-MTG-SUM-001", name: "Client Meeting Summarizer", version: "1.3.0", vendor: "WM Technology", methodology: "GPT-4o structured output + Presidio PII + compliance rules + HITL", baseModel: "gpt-4o", risk: "high", status: "monitoring", usesRag: false, handlesPii: true, clientFacing: true, dataClass: "pii", certDate: "2025-11-01", nextRecert: "2026-05-01", owner: "WM Technology" },
  ...
  { id: "WM-REG-DET-001", name: "Regulatory Change Detector", version: "1.0.0", vendor: "Compliance", methodology: "Semantic embedding + ChromaDB similarity + GPT-4o impact analysis", baseModel: "gpt-4o", risk: "medium", status: "testing", usesRag: true, handlesPii: false, clientFacing: false, dataClass: "internal", certDate: null, nextRecert: null, owner: "Compliance" },
  { id: "WM-CMP-CHK-001", name: "Compliance Checker", version: "1.0.0", vendor: "Compliance", methodology: "GPT-4o classification + deterministic rule engine (FINRA 2210/2111)", baseModel: "gpt-4o", risk: "high", status: "certified", usesRag: false, handlesPii: true, clientFacing: false, dataClass: "confidential", certDate: "2026-02-05", nextRecert: "2026-08-05", owner: "Compliance" },
];
